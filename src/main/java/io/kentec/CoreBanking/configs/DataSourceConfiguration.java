package io.kentec.CoreBanking.configs;
...
@EnableJpaRepositories("io.kentec.CoreBanking.repository")
public class DataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManagerFactoryBean() {
        ...
        lcemfb.setPersistenceUnitName("CoreBanking");
        lcemfb.setPackagesToScan("io.kentec.CoreBanking");
        return lcemfb;
    }
